...
Copy your public key. Select *Add SSH key* in `your account settings <https://control.divio.com/account/ssh-keys/>`_, and paste the key.
...
If you haven’t already done so, you will need to create an SSH key. We recommend `GitHub's excellent guides on checking and generating SSH keys
